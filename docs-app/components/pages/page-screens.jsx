...
/>`}>
        ...
        <Demo name="top-nav-mobile-sections" variant="col" desc="icon + mobileMenuSections + onClick — labeled row groups in the mobile sheet, styled consistently; onClick renders a row as a button instead of a link, e.g. sign out. Sections collapse behind their label by default (same accordion treatment as flyout groups) — set defaultOpen to start expanded, or collapsible={false} to always show (open on a narrow viewport to see it)" code={`<TopNav
  projectName="Mission Control"
  navItems={[
