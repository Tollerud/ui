        ...
        <div className="ds-col" style={{ gap: 12 }}>
          <Card>
            ...
            <p style={{ fontSize: 13.5, color: 'var(--text-secondary)', margin: 0, lineHeight: 1.55 }}>
              Primitives: <code className="ds-mono">EmailLayout</code>, <code className="ds-mono">EmailHeader</code> (monogram + project name large), <code className="ds-mono">BrandMark</code>, <code className="ds-mono">EmailButton</code>, <code className="ds-mono">EmailHeading</code>, <code className="ds-mono">EmailText</code>, <code className="ds-mono">EmailDivider</code>, <code className="ds-mono">EmailFooter</code> (Tollerud footer → tollerud.no; wordmark recolors as one in dark clients, centered fine print below). Templates: <code className="ds-mono">WelcomeEmail</code>, <code className="ds-mono">VerifyEmail</code>, <code className="ds-mono">PasswordResetEmail</code>, <code className="ds-mono">ReceiptEmail</code> — each takes optional <code className="ds-mono">header</code> and an overridable <code className="ds-mono">copy</code> (reword / i18n). Every primitive takes an optional <code className="ds-mono">style</code> escape hatch. Render with the re-exported <code className="ds-mono">render</code>.
            </p>
          </Card>
          <CodeSnippet
            name="email.tsx"
